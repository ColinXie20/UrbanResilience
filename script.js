...
let elements = [
  ...
  [289, 477, 534, 665, "Vegetable Gardens", "Vegetable gardens improve food security by increasing access to fresh food, which makes urban communities more resilient to climate change and extreme weather events. They can also reduce the carbon emissions associated with food production and transportation. Finally, gardening can deepen the connection between people and nature."],
  [906, 298, 1007, 371, "Vegetable Gardens", "Vegetable gardens improve food security by increasing access to fresh food, which makes urban communities more resilient to climate change and extreme weather events. They can also reduce the carbon emissions associated with food production and transportation. Finally, gardening can deepen the connection between people and nature."],
  [1266, 135, 1385, 229, "Vegetable Gardens", "Vegetable gardens improve food security by increasing access to fresh food, which makes urban communities more resilient to climate change and extreme weather events. They can also reduce the carbon emissions associated with food production and transportation. Finally, gardening can deepen the connection between people and nature."],
  [1210, 490, 2180, 800, "Community Parks", "Community parks are major green spaces, helping to filter pollutants and reduce the heat island effect, as well as increasing biodiversity by supporting plant and animal life. They manage stormwater, making cities less vulnerable to floods. Going to parks also provides an opportunity to connect people with nature."],
